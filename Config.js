const Config = (function () {
  ...
  var DeviceKeyIdentifier = env.DeviceKeyIdentifier;
  ...
  // NOTA: Este campo é auto populado pelo arquivo environment importado na linha 1.
  var PublicFaceScanEncryptionKey = env.PublicFaceScanEncryptionKey;
  ...
  var ProductionKeyText = env.ProductionKeyText;
  ...
  // A chave de produção é obtida do backend em tempo de execução, então ela
  // chega por parâmetro. env.ProductionKeyText é apenas um placeholder e não
  // serve para inicializar o SDK.
